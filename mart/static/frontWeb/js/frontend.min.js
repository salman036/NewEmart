;var MonsterInsights = function () {
    ...
    function m(e) {
        var u = c(), i = d(), t = 'unknown', g = e.href, v = h(e.href), p = f(), s = e.hostname, o = e.protocol,
            y = e.pathname;
        g = g.toString();
    ...
    function g(i) {
        var r = i.srcElement || i.target, t = [], l;
        t.el = r;
        t.ga_loaded = u();
        t.click_type = y(i);
        if (!u() || !p(i)) {
        ...
        if (r && r.href && !r.hasAttribute('xlink:href')) {
            var g = r.href, O = h(r.href), K = c(), E = d(), D = monsterinsights_frontend.home_url, I = f(), o = m(r),
                T = b(r, i), v = r.getAttribute('data-vars-ga-action'), w = r.getAttribute('data-vars-ga-label');
            t.el = r;
            t.el_href = r.href;
            ...
            if (o !== 'internal' && o !== 'javascript') {
                ...
                if (T || o == 'mailto' || o == 'tel') {
                    if (o == 'download') {
                        ...
                        l = {hitType: 'event', eventCategory: a, eventAction: v || g, eventLabel: w || t.title,};
                        e(t, l)
                    } else if (o == 'external') {
                        l = {
                            hitType: 'event',
                        ...
                        if (o && o != 'internal') {
                            l = {hitType: 'event', eventCategory: o, eventAction: v || g, eventLabel: w || t.title,};
                            e(t, l)
                        } else {
                            t.exit = 'type';
                            n(t)
    ...
    if (typeof Array.prototype.lastIndexOf !== 'function') {
        Array.prototype.lastIndexOf = function (e) {
            ...
            ;var t, n, a = Object(this), i = a.length >>> 0;
            if (i === 0) {
                return -1
            }
            ;t = i - 1;
